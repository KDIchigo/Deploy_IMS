...
export const MyTable = ({
  ...
  const data = [];
  for (let index = 0; index < classSettings.data.length; index++) {
    const issue_setting = classSettings.data[index];
    let i = index + 1;
    data.push({
    ...
    <div className="d-flex flex-column flexGrow_1">
      ...
      >
        ...
        <BasePagination
          ...
          totalRecord={classSettings.totalRecord}
        />
      </ConfigProvider>
    </div>
  );

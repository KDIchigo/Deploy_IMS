...
export const NewIssue = ({
  ...
  const formik = useFormik({
    initialValues: {
      description: "",
      issue_title: "",
      issue_type: issueType.issue_setting_id,
      issue_status: "",
      work_process: "",
      due_date: "",
      status: 1,
  ...
  return (
    <>
      ...
      <Modal isOpen={modal} toggle={toggle} fullscreen>
        ...
        >
          <ModalHeader toggle={toggle}>New Issue</ModalHeader>
          ...
          <ModalFooter className="mt-auto">
            {loadingData ? (
              ...
              <BaseButton
                nameTitle="ms-3 px-3 btnLoadingAddIssue "
                type="submit"
                color="secondary"
              ...
              <BaseButton
                className="ms-3 px-3 btnAddIssue"
                type="submit"
                value="Add New"
                color="secondary"
              />

...
import { FilterProjectSettings } from "./FilterProjectSettings/FilterProjectSettings";
import { NewProjectSettings } from "./NewProjectSettings/NewProjectSettings";
import "./ProjectSettings.scss";
import { ProjectSettingsTable } from "./ProjectSettingsTable/ProjectSettingsTable";
...
export const ProjectSettings = ({ projectId, project }) => {
  ...
  const fetchData = async (searchParams) => {
    ...
    setProjectSettings(issueSettingArr);
    setLoading(false);
    setSpin(true);
  };
    ...
    <Box className="d-flex flex-column flexGrow_1 flex_height">
      ...
      <div className="row p-0 m-0  mb-2 align-items-center justify-content-between ">
        <h3 className="fw-bold m-0" style={{ paddingBottom: 20 }}>
          Setting for {project.project_code}
        </h3>
